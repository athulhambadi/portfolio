...
export default function AboutFull() {
  return (
    <section id="about" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-7 space-y-16 lg:pt-8">
          ...
          {/* Core Skills */}
          <section>
            <h3 className="text-2xl font-bold tracking-tight mb-6 flex items-center gap-4">
          ...
          {/* Experience Timeline */}
          <section>
            <h3 className="text-2xl font-bold tracking-tight mb-8 flex items-center gap-4">
                ...
                <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-1.25rem)] p-4 rounded-xl border border-zinc-800 bg-zinc-900/50 group-hover:border-zinc-700 transition-colors">
                    <div className="flex flex-col">
                      <h4 className="font-semibold text-white text-lg">{exp.role}</h4>
